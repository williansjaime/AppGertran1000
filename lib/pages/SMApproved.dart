...
List<String> tiposStatus = ["Rascunho","Em_Avaliação","Aguardando_inicio_de_viagem","Em_viagem",
     "Finalizado","Encerrado_com_sucesso","cancelado","Reprovado","Provavel_sinistro",
     "Sinistro_caracterizado","Encerrado_sem_sucesso","Encerrado_reprovado","Pendente","Simulação"];
