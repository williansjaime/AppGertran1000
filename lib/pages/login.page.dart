  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: <Widget>[
            ...
            child:Image.asset('assets/images/imgfundoGertran01.jpeg',
         ...
         child:
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  if(controller.text.length == 14 || controller.text.length == 18)
                  {               
                    var filter = (((controller.text.replaceAll(".", "")).replaceAll(".", "")).replaceAll(".", "")).replaceAll("-", "");
                    final exp = RegExp(r"/");
                    ...
                    Navigator.of(context).pushAndRemoveUntil(
                          MaterialPageRoute(
                            builder: (context) => LoginValidate(cnpj: filter)),
